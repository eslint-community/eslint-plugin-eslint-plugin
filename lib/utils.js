...
/**
* Performs static analysis on an AST to try to determine the final value of `.
...
for the final values of `meta` and `create`. `isNewStyle` will be `true` if `
is an object, and `false` if is just the `create` function. If no valid ESLint rule info can be extracted
